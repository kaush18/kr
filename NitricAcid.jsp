      ...
      <nav class="navbar navbar-inverse" role="banner">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.jsp">Chemical's</a>
...
try
{
    Class.forName("com.mysql.jdbc.Driver");
      ...
      ResultSetMetaData rmd;
	   ...
	   String s1="select pid,pic,pdesc,rate,gst from product where Category='Nitric Acid'";
        ...
        out.println("<td><b><img src="+s+" width=100 height=100></img></b></td>");
            ...
            out.println("<td><b>"+s+"</b></td>");
              ...
              out.println("<td><b>"+s+"</b></td>");
                     ...
                     out.println("<td><b><a href=addcart.jsp?d="+id+"&c=NitricAcid"+"&gst="+gst+"&rate="+rate+"></img></b><img src='addtocart.png'></img><a/></td>");
