...
try
{
 ...
 PreparedStatement pstmt=con.prepareStatement("Update payment2 set status='Dispatched' where billno=?");
    ...
    out.println("<h1 align=center style='color:red'> Dispatched Successfully....");
