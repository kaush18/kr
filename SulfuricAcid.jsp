...
try
{
    Class.forName("com.mysql.jdbc.Driver");
      ...
      ResultSetMetaData rmd;
	   ...
	   String s1="select pid,pic,pdesc,rate,gst from product where Category='Sulfuric Acid'";
        ...
        out.println("<td><b><img src="+s+" width=100 height=100></img></b></td>");
            ...
            out.println("<td><b>"+s+"</b></td>");
              ...
              out.println("<td><b>"+s+"</b></td>");
                     ...
                     out.println("<td><b><a href=addcart.jsp?d="+id+"&c=SulfuricAcid"+"&gst="+gst+"&rate="+rate+"></img></b><img src='addtocart.png'></img><a/></td>");
