...
<div class="container">
			<div class="center wow fadeInDown">
				<h2>About us</h2>
				<p class="lead">This industry utilizes chemical processes such as chemical reactions and refining methods to convert raw materials - such as oil,natural gas,air,water,metals and minerals into chemical products.</p>
				<p class="lead">&nbsp;</p>
				<p class="lead">&nbsp;</p>
    </div>
