...
try
{
    Class.forName("com.mysql.jdbc.Driver");
      ...
      ResultSetMetaData rmd;
	   ...
	   String s1="select pic,rate,pdesc,gst,pid from product";
        ...
        while (rs.next())
        {
            out.println("<tr>");
                ...
                for(int x=1;x<=n;x++)
                {
					 ...
					 if(x==1)
					 {
        out.println("<td><b><img src="+s+" width=50 height=50></img></b></td>");
					 }
					  else
					  {
                     ...
                     out.println("<td><b><a href=eproduct1.jsp?d="+s5+"><p style='color:#000'><img src=edititemicon.jpg width=50 height=50></img></p></b><a/>");
					  out.println("<b><a href=dproduct.jsp?d="+s5+"><p style='color:#000'><img src=deleteicon.jpg width=50 height=50></img></p></b><a/></td>");
