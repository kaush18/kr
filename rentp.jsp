...
<body>
    ...
    <section id="about-us">
        ...
        <table width="75%" border="0" align="center">
          <tr>
            <td colspan="2"><div align="center"><h1 style="color:#993300;">Rent a Plant</h1></div></td>
          </tr>
          <tr>
            <td colspan="2"><div align="center"><img src="rentaplant.jpg" width="400" height="225" /></div></td>
          </tr>
          <tr>
            <td width="36%">&nbsp;</td>
            <td width="64%">&nbsp;</td>
...
<div class="center wow fadeInDown"></div>
