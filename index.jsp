    ...
    <section id="main-slider" class="no-margin">
        <div class="carousel slide">
            ...
            <div class="carousel-inner">
                ...
                <div class="item active" style="background-image: url(3.jpg)">
                    <div class="container">
                        <div class="row slide-margin">
                            <div class="col-sm-6">
                                <div class="carousel-content">
                                    <h1 class="animation animated-item-1">FACTS : A rubber tyre is actually one single giant molecular.</h1>
                                    <h2 class="animation animated-item-2">Buy all type of chemicals...</h2>
                                                                    </div>
                            </div>
                ...
                <div class="item" style="background-image: url(1.jpg)">
                    <div class="container">
                        <div class="row slide-margin">
                            <div class="col-sm-6">
                                <div class="carousel-content">
                                    <h1 class="animation animated-item-1">FACTS : Air becomes liquid at about minus 190 degree celsius .</h1>
                                    <h2 class="animation animated-item-2">Buy all type of chemicals...</h2>
                                                                   </div>
                            </div>
                ...
                <div class="item" style="background-image: url(2.jpg)">
                    <div class="container">
                        <div class="row slide-margin">
                            <div class="col-sm-6">
                                <div class="carousel-content">
                                   <h1 class="animation animated-item-1">FACTS : Hydrofluoric acid will dissolve glass.</h1>
                                    <h2 class="animation animated-item-2">Buy all type of chemicals...</h2>
                                                                 </div>
                            </div>
                            <div class="col-sm-6 hidden-xs animation animated-item-4">
