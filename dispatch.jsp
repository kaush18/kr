...
<body>
    ...
    <nav class="navbar navbar-inverse" role="banner">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.jsp">Chemical supply</a>
                </div> <ul class="nav navbar-nav"> <li><a href="aepw.jsp">Edit Password</a></li>
                        ...
                        <li  class="active"><a href="dispatch.jsp">Dispatch Order View</a></li>
...
try
{
      ...
      ResultSetMetaData rmd;
	   ...
	   String s1="select billno as InvoiceNo,fullname as Name,addr as Address,emailid as Email,ph as Mobile ,status as Status from payment2";
            ...
            out.println("<tr>");
                ...
                for(int x=1;x<=n;x++)
                {
					 ...
					 out.println("<td><b>"+s+"</td>");
					  	           ...
					  	           out.println("<td><b><a href=dispatch1.jsp?id="+s11+"><h4>Dispatch</h4></b><a/></td>");
          }         
