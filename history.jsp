            ...
            <div class="container">
			 ...
			 <ul class="nav navbar-nav"> <li><a href="aepw.jsp">Edit Password</a></li>
                       <li ><a href="aproduct.jsp">Add Product</a></li>
                        ...
                        <li class="active"><a href="history.jsp">Payment History</a></li>
...
"jdbc:mysql://localhost:3306/nursery2020","root","mysql"); 
      ...
      ResultSetMetaData rmd;
	   ...
	   String s1="select billno as Billnumber,bdate as BillDate,famt as TotalAmount,emailid as EmailID,status as Status from payment2";
